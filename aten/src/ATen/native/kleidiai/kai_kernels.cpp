...
/**
 * @brief We maintain a global buffer for Input that needs quantization and packing
 * This is done to avoid memory allocations for every matmul input
 * For now there is no case where the the same buffer is shared across parallel inputs
 */
